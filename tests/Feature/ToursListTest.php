...
class ToursListTest extends TestCase
{
    ...
    public function test_tours_list_sorts_by_price_correctly(): void
    {
        ...
        $response = $this->get('/api/v1/tours/'.$travel->slug.'?sortBy=price&sortOrder=asc');
    ...
    public function test_tours_list_filter_by_price_correctly(): void
    {
        ...
        $endpoint = '/api/v1/tours/'.$travel->slug;
    ...
    public function test_tour_list_return_validation_errors(): void
    {
        ...
        $response = $this->getJson('/api/v1/tours/'.$travel->slug.'?dateFrom=asdasd');
        $response->assertStatus(422);

        $response = $this->getJson('/api/v1/tours/'.$travel->slug.'?priceFrom=asdasd');
        $response->assertStatus(422);
    }
}
